...
<img src="/assets/sumkit_images/give_a_mouse_a.png" width="30">
```json
{
    "b1":"Bobby"
}
```
<img src="/assets/sumkit_images/middle_child.png" width="30">
```json
pageBaseInfo
```
<img src="/assets/sumkit_images/last_cookie.png" width="30">
```json
{
    "baseInfo0":"Bobby"
}
