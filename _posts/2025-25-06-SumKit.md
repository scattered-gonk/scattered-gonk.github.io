...
* As of 7/6/2025, there are currently ~~128~~ **0** variations of the https://portal.gov{two_letters}.top/inbmv domain that are all live and operational. A full list of formely live domains can be found here: <a href="#popup1"> {Malicious URLs using SumKit} </a>
<br>
