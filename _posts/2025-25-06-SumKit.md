...
* As of 7/6/2025, there are currently ~~128~~ **0** variations of the https://portal.gov{two_letters}.top/inbmv domain that are all live and operational.
<br>

This scam site requires you to interact with it via a mobile device; however, if your preferred research environment is a desktop computer or laptop, you may also use User-Agent switching functionalities built into browsers such as Google Chrome.
