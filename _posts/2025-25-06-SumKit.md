...
```js
5B0B164A2EC93DFA9A79696DE5FBDFB4 => stores history of entered data, in the event of a reloaded page
2ADF521149526DDE524F030851C7F903 => stores the current page the user is on
0A2428FDB84C7E7E2BFE5D5A6B52F84A => all of the currently entered data
```