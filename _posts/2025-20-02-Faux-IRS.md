...
We can now approach dissecting the array rotation obfuscation. Here's an example of one such obfuscation (I've taken the liberty of deobfuscating it and converting it to Python for readbility and general mental health):
